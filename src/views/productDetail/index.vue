...
<template>
  <div class="product-detail">
    ...
    <!-- 商品导航 -->
    <van-goods-action>
      <!-- <van-goods-action-icon v-for="(item,i) in goodsActions"
                             :key="i"
                             :icon="item.icon"
                             :badge="!count ? '' : count"
                             :text="item.text">
    ...
    .product-intro {
      ...
      ul {
        ...
        li {
          ...
          //并排放置两个带边框的框，可通过将 box-sizing 设置为 "border-box"
